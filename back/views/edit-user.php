			...
			<ul class="sidebar__nav">
				...
				<li class="sidebar__nav-item">
                    ...
                    <li><a href="add-item.html">Add zoo and park</a></li>
						<li><a href="add-item.html">Add Eco tourism</a></li>
						<li><a href="show-user.php">show zoo and park</a></li>
						<li><a href="edit-user.php">show Eco tourism</a></li>
				...
				<li class="sidebar__nav-item">
					<a href="edit-user.php" class="sidebar__nav-link sidebar__nav-link--active"><i class="icon ion-ios-contacts"></i> <span>Users</span></a>
				</li>
