...
<body>
		...
		<div class="container-fluid">
			...
			<div class="row">
				...
				<div class="col-10">
							...
							<thead>
								...
								?>
										...
										<tr>
											...
											<td>
												<div class="main__table-text"><?php echo $row['type']; ?></div>
											</td>
					...
					<td>
						<a class="btn btn-info" href="update-zoo.php?id=<?php echo $row['id']; ?>">Edit</a><br>&nbsp;
						<a class="modal__btn modal__btn--apply" href="delete-zoo.php?id=<?php echo $row['id']; ?>">Delete</a>
					</td>
					</tr>
	...
	<div id="modal-delete" class="zoom-anim-dialog mfp-hide modal">
		...
		<div class="modal__btns">
			<td>
				<a class="btn btn-info" href="delete-zoo.php?id=<?php echo $row['id']; ?>">Delete</a>
			</td>
