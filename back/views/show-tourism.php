...
<body>
			...
			<ul class="sidebar__nav">
				...
				<li class="sidebar__nav-item">
					...
					<ul class="collapse show sidebar__menu" id="collapseMenu">
						...
						<li><a href="show-zoo.php">show zoo and park</a></li>
						<li><a class="active"href="show-tourism.php">show Eco tourism</a></li>
				...
				<li class="sidebar__nav-item">
					<a href="edit-user.php" class="sidebar__nav-link "><i class="icon ion-ios-contacts"></i> <span>Users</span></a>
				</li>
			...
			<div class="row">
				...
				<div class="col-12">
					<div class="main__title">
                        ...
                        /////table taille
                        ?>
						<span class="main__title-stat">333</span>
							...
							<thead>
								...
								?>
										...
										<tr>
											...
											<td>
												<div class="main__table-text"><?php echo $row['name']; ?></div>
											</td>
											<td>
												<div class="main__table-text"><?php echo $row['description']; ?></div>
											</td>
											<td>
												<div class="main__table-text"><?php echo $row['city']; ?></div>
											</td>
		
					</div>
					</td>
					<td>
						<a class="btn btn-info" href="update-tourism.php?id=<?php echo $row['id']; ?>">Edit</a><br>&nbsp;
						<a class="modal__btn modal__btn--apply" href="delete-tourism.php?id=<?php echo $row['id']; ?>">Delete</a>
					</td>
					</tr>
	...
	<div id="modal-delete" class="zoom-anim-dialog mfp-hide modal">
		...
		<div class="modal__btns">
			<td>
				<a class="btn btn-info" href="delete-tourism.php?id=<?php echo $row['id']; ?>">Delete</a>
			</td>
