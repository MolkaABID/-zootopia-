...
<!-- Mirrored from dmitryvolkov.me/demo/hotflix2.1/admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Apr 2021 21:23:43 GMT -->
<head>
	<meta charset="utf-8">
 ...
 ?> 
		<div class="sidebar__user">
			...
			<div class="sidebar__user-title">
				<span>Admin</span>
				<p><?php echo $_SESSION['prenom']; echo $_SESSION['nom']?></p>
			</div>									
			<button  class="sidebar__user-btn" type="button">
			<a href="../../front/views/logout.php" class="icon ion-ios-log-out"></a>	
...
<!-- Mirrored from dmitryvolkov.me/demo/hotflix2.1/admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Apr 2021 21:24:00 GMT -->
</html>
