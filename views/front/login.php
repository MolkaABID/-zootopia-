        ...
        <main id="main">
            <div class="container">
                <div class="form-login-wrap">
                    <h2 class="title-2 m-b-60">My account</h2>
                    <form class="form-login" action="check-login.php" method="POST">
                        <h3 class="title-5 m-b-25">login</h3>
                        <div class="form-group">
                            <label class="form-label">Username or Email address *</label>
                            <input class="au-input-2" type="text" name="username" id="username">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Password *</label>
                            <input class="au-input-2" type="password" name="mdp" id=mdp>
                        </div>
                        <div class="form-group">
                            <label class="form-label">Select User Type:</label>     
                        </div>
                        <select class="au-input-2"
                        name="role" 
                        ...
                        <div class="form-action">
                            <button class="au-btn au-btn--solid au-btn-xl" type="submit">Login</button>
