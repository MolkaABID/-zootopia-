...
<!-- Mirrored from freebw.com/templates/tatee/my-account.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Apr 2021 20:14:40 GMT -->
...
<body class="animsition js-preloader">
    <div class="page-wrapper">
        ...
        <form name="f1" method="POST" action="ajoutclient.php">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="username" id="username" placeholder="Votre username" type="text">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Nom</label>
                                        <input class="form-control" name="nom" id="nom" placeholder="Votre Nom" type="text" required pattern="[A-Za-z]+">
                                    </div>
                                </div>
                             </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Prenom</label>
                                            <input class="form-control" name="prenom" id="prenom" placeholder="Votre Prenom" type="text" required pattern="[A-Za-z]+">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>CIN</label>
                                            <input class="form-control" name="cin" id="cin" placeholder="Votre Carte d'identité" type="text" required pattern="[0-9]+">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="ddn" id="ddn" placeholder=" votre date de naissance " type="date">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Numero</label>
                                        <input class="form-control" name="num" id="num" placeholder="Votre Numero" type="number">
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                <label>E-mail</label>
                                <input class="form-control" name="email" id="email" placeholder="Votre Email" rows="10" type="texts"></textarea>
                            </div>
                            <select class="au-input-2" name="role" aria-label="Default select example">
                                <option selected value="client">client</option>
                                <option value="admin">Admin</option>
                            </select>
                            <div class="form-group">
                                <label>Mot De Passe</label>
                                <input class="form-control" name="mdp" id="mdp" placeholder="Votre Mot de passe" rows="10" type="password"></textarea>
                            </div>
                            <div class="text-right"><br>
                                <button class="btn btn-primary solid blank" type="submit" onclick="test1()">S'inscrire</button>
        </form>
    </div>
                    ...
                    <div class="footer-col">
                        ...
                        <div class="widget widget-address">
                            <ul>
                                ...
                                <li>Email : <a href="https://freebw.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3367524756561d5241505b5a4756504746415673545e525a5f1d505c5e">[email&#160;protected]</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
