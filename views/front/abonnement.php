    ...
    <div class="page-wrapper">
        ...
        <section id="main-container">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-12 heading">
                        ...
                        <h2 class="title classic">ABONNEMENTS SIMPLES</h2>
                    </div>
                </div><!-- Title row end -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="plan text-center">
                            <span class="plan-name">BILLET D’ENTRÉE ZOO DE JURQUES <small>(Par mois)</small></span>
                            <p class="plan-price"><sup class="currency">DT</sup><strong>50</strong><sub>.00</sub></p>
                            <ul class="list-unstyled">
                                <li>À 20 minutes de Caen. Voyagez sur tous les continents en découvrant l’une des plus…</li>

                                <!--<li>100 Domain Hosting</li>
						<li>SSL Shopping Cart</li>
						<li>24/7 Live Support</li>-->
                            </ul>
                            <a class="btn btn-primary" href="formabonn.html">Commander</a>
                        </div>
                    </div><!-- plan end -->
                    ...
                    <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay="1s">
                        <div class="plan text-center">
                            <span class="plan-name">DANS LA PEAU D’UN SOIGNEUR KID <small>(Par mois)</small></span>
                            <p class="plan-price"><sup class="currency">DT</sup><strong>180</strong><sub>.00</sub></p>
                            <ul class="list-unstyled">
                                <li>Découvrez les coulisses du parc en famille à partir de 8 ans ! Réservez pour…</li>
                    ...
                    <div class="col-md-3 col-sm-6 wow fadeInUp" data-wow-delay="1.4s">
                        <div class="plan text-center featured">
                            <span class="plan-name">DANS LA PEAU D’UN SOIGNEUR <small>(Par mois)</small></span>
                            <p class="plan-price"><sup class="currency">DT</sup><strong>190</strong><sub>.00</sub></p>
                            <ul class="list-unstyled">
                                <li>Découvrez les coulisses du parc en tant que VIP ! Réservez pour la saison 2021 dès…</li>
            ...
            <div class="row">
                <div class="col-md-12 heading">
                    <span class="title-icon classic float-left"><i class="fa fa-university"></i></span>
                    <h2 class="title classic">NOS PACKS</h2>
                </div>
            </div><!-- Title row end -->
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6 wow fadeInUp" data-wow-delay=".5s">
                    <div class="plan text-center">
                        <span class="plan-name">ABONNEMENT ZOO À L’ANNÉE <small>Annuelle</small></span>
                        <p class="plan-price"><sup class="currency">DT</sup><strong>350</strong><sub>.00</sub></p>
                        <ul class="list-unstyled">
                            <li>PROFITEZ DU ZOO TOUTE L’ANNÉE EN ILLIMITÉ !</li>
                            <li>Idéal pour les mordus de la vie sauvage la carte Zoo Pass vous permet aussi de profiter de remises à la boutique et à la cafétéria.</li>
                            <li>Commandez dès aujourd’hui et votre carte sera prête le jour de votre visite !
                                Abonnement valable 1 an à partir de votre première visite.</li>
                            <!--<li>SSL Shopping Cart</li>
						<li>24/7 Live Support</li>-->
                        </ul>
                        <a class="btn btn-primary" href="formabonn.html">Commander</a>
