...
<!-- Mirrored from freebw.com/templates/tatee/project-grid-stand.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Apr 2021 20:14:32 GMT -->
<head>
    <!-- Required meta tags-->
    <meta charset="UTF-8">
                                    ...
                                    <nav class="header-nav-menu">
                                        <ul class="menu nav-menu">
                                            ...
                                            <li class="menu-item menu-item-has-children">
                                                ...
                                                <ul class="sub-menu">
                                                    <li class="menu-item">
                                                        <a href="project-zoo-park.php">Zoo and Park</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="project-eco-tourism.html">Eco Tourism</a>
                                                    </li>
            ...
            <section class="section p-t-100 p-b-65">
                <div class="container">
                    <div class="page-heading">
                        <h4 class="title-sub title-sub--c8 m-b-15">Our Zoos and Parks</h4>
                        <h2 class="title-2">Our Existing Zoos and Parks
                ...
                <div class="container">
                    <div class="row gutter-xl">
                        <div class="col-md-6">
                            <article class="media media-project m-b-50">
                                <figure class="media__img">
                                    <img src="images/djerba-explore-park.jpg" alt="djerba-explore-park" />
                                </figure>
                                ...
                                <div class="media__body">
                                    <h3 class="title">
                                        <a href="project-detail-1.html">DJERBA EXPLORE PARK</a>
                                    </h3>
                                    <div class="address">Djerba, Medenine, Park</div>
                                </div>
                            </article>
                        </div>
                        <div class="col-md-6">
                            <article class="media media-project m-b-50">
                                <figure class="media__img">
                                    <img src="images/The-crocodile-farm.jpg" alt="The-crocodile-farm" />
                                </figure>
                                <div class="bg-overlay"></div>
                                <span class="line"></span>
                                <span class="line line--bottom"></span>
                                <div class="media__body">
                                    <h3 class="title">
                                        <a href="project-detail-1.html">The crocodile farm</a>
                                    </h3>
                                    <div class="address">Djerba, Medenine, Zoo</div>
                                </div>
                            </article>
                        </div>
                        <div class="col-md-6">
                            <article class="media media-project m-b-50">
                                <figure class="media__img">
                                    <img src="images/The-Zoological-Gardens.jpg" alt="The-Zoological-Gardens" />
                                </figure>
                                <div class="bg-overlay"></div>
                                <span class="line"></span>
                                <span class="line line--bottom"></span>
                                <div class="media__body">
                                    <h3 class="title">
                                        <a href="project-detail-1.html">The Zoological Gardens</a>
                                    </h3>
                                    <div class="address">Tunis, Zoo</div>
                                </div>
                            </article>
                        </div>
                        <div class="col-md-6">
                            <article class="media media-project m-b-50">
                                <figure class="media__img">
                                    <img src="images/tozeur-zoo.jpg" alt="tozeur-zoo" />
                                </figure>
                                <div class="bg-overlay"></div>
                                <span class="line"></span>
                                <span class="line line--bottom"></span>
                                <div class="media__body">
                                    <h3 class="title">
                                        <a href="project-detail-1.html">Tozeur Zoo</a>
                                    </h3>
                                    <div class="address">Tozeur, Zoo</div>
                                </div>
                            </article>
                        </div>
                        <div class="col-md-6">
                            <article class="media media-project m-b-50">
                                <figure class="media__img">
                                    <img src="images/Tamerza-canyon.jpg" alt="Tamerza-canyon" />
                                </figure>
                                <div class="bg-overlay"></div>
                                <span class="line"></span>
                                <span class="line line--bottom"></span>
                                <div class="media__body">
                                    <h3 class="title">
                                        <a href="project-detail-1.html">Tamerza Canyon</a>
                                    </h3>
                                    <div class="address">Tozeur, Park</div>
                                </div>
                            </article>
                        </div>
                        <div class="col-md-6">
                            <article class="media media-project m-b-50">
                                <figure class="media__img">
                                    <img src="images/project-38.jpg" alt="wooden villa" />
                                </figure>
                                <div class="bg-overlay"></div>
                                <span class="line"></span>
                                <span class="line line--bottom"></span>
                        ...
                        <div class="col-md-6">
                            <article class="media media-project m-b-50">
                                <figure class="media__img">
                                    <img src="images/project-40.jpg" alt="Skyline" />
                                </figure>
                                <div class="bg-overlay"></div>
                                <span class="line"></span>
                                <span class="line line--bottom"></span>
                        ...
                        <div class="footer-col">
                            ...
                            <div class="widget widget-address">
                                <ul>
                                    ...
                                    <li>Email : <a href="https://freebw.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="d783b6a3b2b2f9b6a5b4bfbea3b2b4a3a2a5b297b0bab6bebbf9b4b8ba">[email&#160;protected]</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<!-- Mirrored from freebw.com/templates/tatee/project-grid-stand.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 20 Apr 2021 20:14:34 GMT -->
</html>
<!-- end document-->